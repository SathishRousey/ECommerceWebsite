            ...
            {products.map(product => {
                ...
                return (
                    <div key={product.id} className='card'>
                        ...
                        <Link to={`/singleProduct/${product.id}`} className='product-name'>
                            {product.name}
                        </Link>
                        <pre>
                            {`$${product.offeredPrice} INR`} <strike>${product.price}</strike>
                            <br />
                            <span style={quantityStyle}>{quantityMessage}</span>
                        </pre>
                        <i className="fa-solid fa-star"></i>
                        <i className="fa-solid fa-star"></i>
                        <i className="fa-solid fa-star"></i>
                        <i className="fa-solid fa-star"></i>
                        <i className="fa-solid fa-star-half-stroke"></i><br />
